    ...
    public class CameraModuleRenderer : ViewRenderer<CameraModule, UIView>, IAVCapturePhotoCaptureDelegate
    {
            ...
            try
            {
                ...
                if (!_cameraModule.AvailableCameras.Any())
                {
                    ...
                    var session = AVCaptureDeviceDiscoverySession.Create(
                        deviceTypes.ToArray(), AVMediaTypes.Video, AVCaptureDevicePosition.Unspecified);
        ...
        private async void CapturePhoto()
        {
            try
            {
                ...
                {
                    using var videoConnection = _stillImageOutput.ConnectionFromMediaType(new NSString(AVMediaTypes.Video.ToString()));
        ...
        {
            var sideWidth = Bounds.Width;
            var sideHeight = Bounds.Height;
